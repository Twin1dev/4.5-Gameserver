...
class UClass* UGAB_SmasherCharge_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_SmasherCharge_C");

	return Clss;
}


// GAB_SmasherCharge_C GAB_SmasherCharge.Default__GAB_SmasherCharge_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_SmasherCharge_C* UGAB_SmasherCharge_C::GetDefaultObj()
{
	static class UGAB_SmasherCharge_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_SmasherCharge_C*>(UGAB_SmasherCharge_C::StaticClass()->DefaultObject);
...
// struct FGameplayAbilityTargetDataHandleTemp_struct_Variable5                                            (None)
