...
class UClass* UFortReplayCameraSettingsTab_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FortReplayCameraSettingsTab_C");

	return Clss;
}


// FortReplayCameraSettingsTab_C FortReplayCameraSettingsTab.Default__FortReplayCameraSettingsTab_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFortReplayCameraSettingsTab_C* UFortReplayCameraSettingsTab_C::GetDefaultObj()
{
	static class UFortReplayCameraSettingsTab_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortReplayCameraSettingsTab_C*>(UFortReplayCameraSettingsTab_C::StaticClass()->DefaultObject);
