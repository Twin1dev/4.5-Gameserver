...
class UClass* ABGA_SuperShielder_Shield_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BGA_SuperShielder_Shield_C");

	return Clss;
}


// BGA_SuperShielder_Shield_C BGA_SuperShielder_Shield.Default__BGA_SuperShielder_Shield_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABGA_SuperShielder_Shield_C* ABGA_SuperShielder_Shield_C::GetDefaultObj()
{
	static class ABGA_SuperShielder_Shield_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABGA_SuperShielder_Shield_C*>(ABGA_SuperShielder_Shield_C::StaticClass()->DefaultObject);
