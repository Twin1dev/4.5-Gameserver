...
public:
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x190(0xA8)(None)
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext1;                       // 0x368(0x18)(None)
	...
	uint8                                        Pad_34F0[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x9A0(0x18)(None)
	...
	TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasMatchingGameplayTag_self1_CastInput;   // 0xCC8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_34FB[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
