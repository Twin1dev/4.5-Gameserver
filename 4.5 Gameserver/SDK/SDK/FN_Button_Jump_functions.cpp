...
class UClass* UButton_Jump_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Button_Jump_C");

	return Clss;
}


// Button_Jump_C Button_Jump.Default__Button_Jump_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UButton_Jump_C* UButton_Jump_C::GetDefaultObj()
{
	static class UButton_Jump_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UButton_Jump_C*>(UButton_Jump_C::StaticClass()->DefaultObject);
