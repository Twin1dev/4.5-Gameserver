...
class UClass* URotatorSelectorReplaySettings_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("RotatorSelectorReplaySettings_C");

	return Clss;
}


// RotatorSelectorReplaySettings_C RotatorSelectorReplaySettings.Default__RotatorSelectorReplaySettings_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class URotatorSelectorReplaySettings_C* URotatorSelectorReplaySettings_C::GetDefaultObj()
{
	static class URotatorSelectorReplaySettings_C* Default = nullptr;

	if (!Default)
		Default = static_cast<URotatorSelectorReplaySettings_C*>(URotatorSelectorReplaySettings_C::StaticClass()->DefaultObject);
