...
public:
	...
	uint8                                        Pad_348A[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasAllMatchingGameplayTags_self_CastInput; // 0x28(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
