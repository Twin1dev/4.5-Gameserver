...
class UClass* UFortReplayNotification_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FortReplayNotification_C");

	return Clss;
}


// FortReplayNotification_C FortReplayNotification.Default__FortReplayNotification_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFortReplayNotification_C* UFortReplayNotification_C::GetDefaultObj()
{
	static class UFortReplayNotification_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortReplayNotification_C*>(UFortReplayNotification_C::StaticClass()->DefaultObject);
