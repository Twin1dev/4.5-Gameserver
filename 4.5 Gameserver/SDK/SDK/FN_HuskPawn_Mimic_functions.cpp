...
class UClass* AHuskPawn_Mimic_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HuskPawn_Mimic_C");

	return Clss;
}


// HuskPawn_Mimic_C HuskPawn_Mimic.Default__HuskPawn_Mimic_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AHuskPawn_Mimic_C* AHuskPawn_Mimic_C::GetDefaultObj()
{
	static class AHuskPawn_Mimic_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AHuskPawn_Mimic_C*>(AHuskPawn_Mimic_C::StaticClass()->DefaultObject);
