...
{
public:
	struct FSlateBrush                           Temp_struct_Variable;                              // 0x0(0x88)(None)
	struct FSlateBrush                           Temp_struct_Variable1;                             // 0x88(0x88)(None)
	...
	struct FSlateBrush                           Temp_struct_Variable2;                             // 0x118(0x88)(None)
	struct FSlateBrush                           Temp_struct_Variable3;                             // 0x1A0(0x88)(None)
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush;                      // 0x238(0x88)(None)
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush1;                     // 0x2C0(0x88)(None)
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush2;                     // 0x348(0x88)(None)
	struct FSlateBrush                           K2Node_Select_Default;                             // 0x3D0(0x88)(None)
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush3;                     // 0x458(0x88)(None)
	struct FSlateBrush                           K2Node_Select1_Default;                            // 0x4E0(0x88)(None)
};
