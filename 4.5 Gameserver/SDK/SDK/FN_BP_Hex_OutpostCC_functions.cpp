...
class UClass* ABP_Hex_OutpostCC_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Hex_OutpostCC_C");

	return Clss;
}


// BP_Hex_OutpostCC_C BP_Hex_OutpostCC.Default__BP_Hex_OutpostCC_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Hex_OutpostCC_C* ABP_Hex_OutpostCC_C::GetDefaultObj()
{
	static class ABP_Hex_OutpostCC_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Hex_OutpostCC_C*>(ABP_Hex_OutpostCC_C::StaticClass()->DefaultObject);
