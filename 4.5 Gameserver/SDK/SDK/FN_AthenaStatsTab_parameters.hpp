...
public:
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1;              // 0x50(0x18)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0x90(0x18)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue3;              // 0xB0(0x18)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue4;              // 0xE0(0x18)(None)
};
...
public:
	...
	uint8                                        Pad_4F9F[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetCurrentSeasonName_ReturnValue;         // 0x180(0x18)(None)
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1;              // 0x198(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x228(0x18)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0x2A0(0x18)(None)
