...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable3;                             // 0x160(0x20)(None)
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActorArray_ReturnValue; // 0x290(0x20)(None)
	...
	uint8                                        Pad_36AC[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
