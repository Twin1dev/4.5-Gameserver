...
class UClass* UPartyFinder_LFG_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PartyFinder_LFG_C");

	return Clss;
}


// PartyFinder_LFG_C PartyFinder_LFG.Default__PartyFinder_LFG_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPartyFinder_LFG_C* UPartyFinder_LFG_C::GetDefaultObj()
{
	static class UPartyFinder_LFG_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPartyFinder_LFG_C*>(UPartyFinder_LFG_C::StaticClass()->DefaultObject);
