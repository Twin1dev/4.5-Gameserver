...
class UClass* UGAB_AIBaseMelee_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_AIBaseMelee_C");

	return Clss;
}


// GAB_AIBaseMelee_C GAB_AIBaseMelee.Default__GAB_AIBaseMelee_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_AIBaseMelee_C* UGAB_AIBaseMelee_C::GetDefaultObj()
{
	static class UGAB_AIBaseMelee_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_AIBaseMelee_C*>(UGAB_AIBaseMelee_C::StaticClass()->DefaultObject);
