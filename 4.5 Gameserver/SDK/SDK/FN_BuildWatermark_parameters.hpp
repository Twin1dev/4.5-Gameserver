...
public:
	...
	class FText                                  CallFunc_GetMCPRegion_ReturnValue;                 // 0x10(0x18)(None)
	class FText                                  CallFunc_GetPlayAgainstWatermarkText_ReturnValue;  // 0x28(0x18)(None)
	class FText                                  CallFunc_GetFillWithWatermarkText_ReturnValue;     // 0x40(0x18)(None)
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue1;           // 0xA8(0x18)(None)
