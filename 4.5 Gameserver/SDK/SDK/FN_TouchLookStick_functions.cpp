...
class UClass* UTouchLookStick_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TouchLookStick_C");

	return Clss;
}


// TouchLookStick_C TouchLookStick.Default__TouchLookStick_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTouchLookStick_C* UTouchLookStick_C::GetDefaultObj()
{
	static class UTouchLookStick_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTouchLookStick_C*>(UTouchLookStick_C::StaticClass()->DefaultObject);
