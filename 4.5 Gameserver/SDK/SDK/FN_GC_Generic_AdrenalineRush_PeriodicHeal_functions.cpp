...
class UClass* AGC_Generic_AdrenalineRush_PeriodicHeal_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Generic_AdrenalineRush_PeriodicHeal_C");

	return Clss;
}


// GC_Generic_AdrenalineRush_PeriodicHeal_C GC_Generic_AdrenalineRush_PeriodicHeal.Default__GC_Generic_AdrenalineRush_PeriodicHeal_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Generic_AdrenalineRush_PeriodicHeal_C* AGC_Generic_AdrenalineRush_PeriodicHeal_C::GetDefaultObj()
{
	static class AGC_Generic_AdrenalineRush_PeriodicHeal_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Generic_AdrenalineRush_PeriodicHeal_C*>(AGC_Generic_AdrenalineRush_PeriodicHeal_C::StaticClass()->DefaultObject);
