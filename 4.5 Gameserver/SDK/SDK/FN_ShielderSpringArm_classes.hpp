...
public:
	...
	uint8                                        Pad_3987[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               TruMinusMid_Point;                                 // 0x46C(0xC)(Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
