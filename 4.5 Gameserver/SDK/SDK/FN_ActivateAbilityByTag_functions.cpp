...
class UClass* UActivateAbilityByTag_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ActivateAbilityByTag_C");

	return Clss;
}


// ActivateAbilityByTag_C ActivateAbilityByTag.Default__ActivateAbilityByTag_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UActivateAbilityByTag_C* UActivateAbilityByTag_C::GetDefaultObj()
{
	static class UActivateAbilityByTag_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UActivateAbilityByTag_C*>(UActivateAbilityByTag_C::StaticClass()->DefaultObject);
