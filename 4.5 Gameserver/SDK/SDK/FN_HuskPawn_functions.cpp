...
class UClass* AHuskPawn_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HuskPawn_C");

	return Clss;
}


// HuskPawn_C HuskPawn.Default__HuskPawn_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AHuskPawn_C* AHuskPawn_C::GetDefaultObj()
{
	static class AHuskPawn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AHuskPawn_C*>(AHuskPawn_C::StaticClass()->DefaultObject);
