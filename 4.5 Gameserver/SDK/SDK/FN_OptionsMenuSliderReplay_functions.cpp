...
class UClass* UOptionsMenuSliderReplay_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("OptionsMenuSliderReplay_C");

	return Clss;
}


// OptionsMenuSliderReplay_C OptionsMenuSliderReplay.Default__OptionsMenuSliderReplay_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UOptionsMenuSliderReplay_C* UOptionsMenuSliderReplay_C::GetDefaultObj()
{
	static class UOptionsMenuSliderReplay_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UOptionsMenuSliderReplay_C*>(UOptionsMenuSliderReplay_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetSliderValueText_ValueText                            (None)
