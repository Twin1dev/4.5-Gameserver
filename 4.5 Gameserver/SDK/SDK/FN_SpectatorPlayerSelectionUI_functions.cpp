...
class UClass* USpectatorPlayerSelectionUI_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SpectatorPlayerSelectionUI_C");

	return Clss;
}


// SpectatorPlayerSelectionUI_C SpectatorPlayerSelectionUI.Default__SpectatorPlayerSelectionUI_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USpectatorPlayerSelectionUI_C* USpectatorPlayerSelectionUI_C::GetDefaultObj()
{
	static class USpectatorPlayerSelectionUI_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USpectatorPlayerSelectionUI_C*>(USpectatorPlayerSelectionUI_C::StaticClass()->DefaultObject);
