...
class UClass* UMulchConfirmationModalWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MulchConfirmationModalWidget_C");

	return Clss;
}


// MulchConfirmationModalWidget_C MulchConfirmationModalWidget.Default__MulchConfirmationModalWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMulchConfirmationModalWidget_C* UMulchConfirmationModalWidget_C::GetDefaultObj()
{
	static class UMulchConfirmationModalWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMulchConfirmationModalWidget_C*>(UMulchConfirmationModalWidget_C::StaticClass()->DefaultObject);
