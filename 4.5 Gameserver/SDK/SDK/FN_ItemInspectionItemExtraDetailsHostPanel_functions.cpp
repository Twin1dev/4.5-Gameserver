...
void UItemInspectionItemExtraDetailsHostPanel_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ItemInspectionItemExtraDetailsHostPanel_C", "Construct");
...
void UItemInspectionItemExtraDetailsHostPanel_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ItemInspectionItemExtraDetailsHostPanel_C", "PreConstruct");

	Params::UItemInspectionItemExtraDetailsHostPanel_C_PreConstruct_Params Parms{};
...
void UItemInspectionItemExtraDetailsHostPanel_C::ExecuteUbergraph_ItemInspectionItemExtraDetailsHostPanel(int32 EntryPoint, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable1, bool K2Node_Event_IsDesignTime, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
