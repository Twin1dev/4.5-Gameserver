...
class UClass* UFortReplayTransport_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FortReplayTransport_C");

	return Clss;
}


// FortReplayTransport_C FortReplayTransport.Default__FortReplayTransport_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFortReplayTransport_C* UFortReplayTransport_C::GetDefaultObj()
{
	static class UFortReplayTransport_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortReplayTransport_C*>(UFortReplayTransport_C::StaticClass()->DefaultObject);
