...
class UClass* UGAT_ConstructorActiveAbility_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAT_ConstructorActiveAbility_C");

	return Clss;
}


// GAT_ConstructorActiveAbility_C GAT_ConstructorActiveAbility.Default__GAT_ConstructorActiveAbility_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAT_ConstructorActiveAbility_C* UGAT_ConstructorActiveAbility_C::GetDefaultObj()
{
	static class UGAT_ConstructorActiveAbility_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAT_ConstructorActiveAbility_C*>(UGAT_ConstructorActiveAbility_C::StaticClass()->DefaultObject);
