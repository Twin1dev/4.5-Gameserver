...
public:
	...
	struct FFortUIPerk                           CallFunc_Array_Get_Item1;                          // 0xE8(0x98)(None)
...
public:
	...
	class FText                                  CallFunc_GetTooltipTextFromToken_OutText;          // 0x118(0x18)(None)
	...
	class FText                                  CallFunc_GetTooltipTextFromToken_OutText1;         // 0x138(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x298(0x18)(None)
