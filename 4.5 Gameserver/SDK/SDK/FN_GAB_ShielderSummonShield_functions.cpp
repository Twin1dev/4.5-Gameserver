...
class UClass* UGAB_ShielderSummonShield_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_ShielderSummonShield_C");

	return Clss;
}


// GAB_ShielderSummonShield_C GAB_ShielderSummonShield.Default__GAB_ShielderSummonShield_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_ShielderSummonShield_C* UGAB_ShielderSummonShield_C::GetDefaultObj()
{
	static class UGAB_ShielderSummonShield_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_ShielderSummonShield_C*>(UGAB_ShielderSummonShield_C::StaticClass()->DefaultObject);
