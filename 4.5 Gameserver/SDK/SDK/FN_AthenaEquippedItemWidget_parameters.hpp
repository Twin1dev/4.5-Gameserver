...
public:
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0xE0(0x18)(None)
...
public:
	...
	struct FSlateBrush                           CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue; // 0x58(0x88)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue1;              // 0xF8(0x18)(None)
	struct FSlateBrush                           CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue1; // 0x110(0x88)(None)
	...
	class FText                                  CallFunc_GetRemainingAmmoText_CurrentAmmoText;     // 0x1A8(0x18)(None)
	...
	class FText                                  CallFunc_GetCurrentAmmoText_CurrentAmmoText;       // 0x1C8(0x18)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue2;              // 0x1F0(0x18)(None)
	...
	struct FSlateBrush                           CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue2; // 0x218(0x88)(None)
};
