...
{
public:
	uint8                                        Pad_1BA[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FMovieSceneFloatChannel               Translation[0x2];                                  // 0x48(0x120)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               Rotation;                                          // 0x168(0x90)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               Scale[0x2];                                        // 0x1F8(0x120)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               Shear[0x2];                                        // 0x318(0x120)(NativeAccessSpecifierPrivate)
