...
class UClass* UAthenaCustomizationTab_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaCustomizationTab_C");

	return Clss;
}


// AthenaCustomizationTab_C AthenaCustomizationTab.Default__AthenaCustomizationTab_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaCustomizationTab_C* UAthenaCustomizationTab_C::GetDefaultObj()
{
	static class UAthenaCustomizationTab_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaCustomizationTab_C*>(UAthenaCustomizationTab_C::StaticClass()->DefaultObject);
