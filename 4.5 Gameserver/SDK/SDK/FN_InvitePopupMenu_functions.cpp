...
class UClass* UInvitePopupMenu_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("InvitePopupMenu_C");

	return Clss;
}


// InvitePopupMenu_C InvitePopupMenu.Default__InvitePopupMenu_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInvitePopupMenu_C* UInvitePopupMenu_C::GetDefaultObj()
{
	static class UInvitePopupMenu_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInvitePopupMenu_C*>(UInvitePopupMenu_C::StaticClass()->DefaultObject);
