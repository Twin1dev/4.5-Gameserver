...
class UClass* UResolutionScaleSlider_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ResolutionScaleSlider_C");

	return Clss;
}


// ResolutionScaleSlider_C ResolutionScaleSlider.Default__ResolutionScaleSlider_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UResolutionScaleSlider_C* UResolutionScaleSlider_C::GetDefaultObj()
{
	static class UResolutionScaleSlider_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UResolutionScaleSlider_C*>(UResolutionScaleSlider_C::StaticClass()->DefaultObject);
