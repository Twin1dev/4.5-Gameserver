...
class UClass* UMinibossDetails_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MinibossDetails_C");

	return Clss;
}


// MinibossDetails_C MinibossDetails.Default__MinibossDetails_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMinibossDetails_C* UMinibossDetails_C::GetDefaultObj()
{
	static class UMinibossDetails_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMinibossDetails_C*>(UMinibossDetails_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetHUDTargetUpgradeDisplayName_ReturnValue              (None)
// class FText                        CallFunc_GetHUDTargetDisplayName_ReturnValue                     (None)
