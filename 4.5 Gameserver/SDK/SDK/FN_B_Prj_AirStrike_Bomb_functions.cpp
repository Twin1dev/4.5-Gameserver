...
class UClass* AB_Prj_AirStrike_Bomb_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Prj_AirStrike_Bomb_C");

	return Clss;
}


// B_Prj_AirStrike_Bomb_C B_Prj_AirStrike_Bomb.Default__B_Prj_AirStrike_Bomb_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Prj_AirStrike_Bomb_C* AB_Prj_AirStrike_Bomb_C::GetDefaultObj()
{
	static class AB_Prj_AirStrike_Bomb_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Prj_AirStrike_Bomb_C*>(AB_Prj_AirStrike_Bomb_C::StaticClass()->DefaultObject);
