...
public:
	...
	class UMaterialInstanceDynamic*              MIDMinusCheckBox;                                  // 0x368(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
