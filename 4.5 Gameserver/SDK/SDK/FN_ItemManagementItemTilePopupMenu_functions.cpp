...
class UClass* UItemManagementItemTilePopupMenu_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ItemManagementItemTilePopupMenu_C");

	return Clss;
}


// ItemManagementItemTilePopupMenu_C ItemManagementItemTilePopupMenu.Default__ItemManagementItemTilePopupMenu_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UItemManagementItemTilePopupMenu_C* UItemManagementItemTilePopupMenu_C::GetDefaultObj()
{
	static class UItemManagementItemTilePopupMenu_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UItemManagementItemTilePopupMenu_C*>(UItemManagementItemTilePopupMenu_C::StaticClass()->DefaultObject);
