...
public:
	...
	struct FSlateBrush                           K2Node_MakeStruct_SlateBrush1;                     // 0x110(0x88)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue;              // 0x198(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue1;             // 0x1B0(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue2;             // 0x1C8(0x18)(None)
	class FText                                  CallFunc_MakeLiteralText_ReturnValue3;             // 0x1E0(0x18)(None)
	class FText                                  Temp_text_Variable;                                // 0x1F8(0x18)(None)
	class FText                                  Temp_text_Variable1;                               // 0x210(0x18)(None)
	...
	class FText                                  Temp_text_Variable2;                               // 0x2D0(0x18)(None)
	class FText                                  Temp_text_Variable3;                               // 0x2E8(0x18)(None)
	...
	struct FSlateBrush                           K2Node_Select1_Default;                            // 0x328(0x88)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x440(0x18)(None)
};
