...
class UClass* APlayerPawn_Ninja_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlayerPawn_Ninja_C");

	return Clss;
}


// PlayerPawn_Ninja_C PlayerPawn_Ninja.Default__PlayerPawn_Ninja_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class APlayerPawn_Ninja_C* APlayerPawn_Ninja_C::GetDefaultObj()
{
	static class APlayerPawn_Ninja_C* Default = nullptr;

	if (!Default)
		Default = static_cast<APlayerPawn_Ninja_C*>(APlayerPawn_Ninja_C::StaticClass()->DefaultObject);
