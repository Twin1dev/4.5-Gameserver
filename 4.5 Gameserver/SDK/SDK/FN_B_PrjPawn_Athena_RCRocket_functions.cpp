...
class UClass* AB_PrjPawn_Athena_RCRocket_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_PrjPawn_Athena_RCRocket_C");

	return Clss;
}


// B_PrjPawn_Athena_RCRocket_C B_PrjPawn_Athena_RCRocket.Default__B_PrjPawn_Athena_RCRocket_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_PrjPawn_Athena_RCRocket_C* AB_PrjPawn_Athena_RCRocket_C::GetDefaultObj()
{
	static class AB_PrjPawn_Athena_RCRocket_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_PrjPawn_Athena_RCRocket_C*>(AB_PrjPawn_Athena_RCRocket_C::StaticClass()->DefaultObject);
