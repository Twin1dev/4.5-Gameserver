...
public:
	...
	struct FFortItemQuantityPair                 CallFunc_Array_Get_Item;                           // 0x118(0x30)(None)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array1;                           // 0x148(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x158(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue3;                      // 0x2A0(0x18)(None)
	...
	class FText                                  CallFunc_MakeLiteralText_ReturnValue;              // 0x2C0(0x18)(None)
