...
class UClass* UGAB_SmasherRadialMelee_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_SmasherRadialMelee_C");

	return Clss;
}


// GAB_SmasherRadialMelee_C GAB_SmasherRadialMelee.Default__GAB_SmasherRadialMelee_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_SmasherRadialMelee_C* UGAB_SmasherRadialMelee_C::GetDefaultObj()
{
	static class UGAB_SmasherRadialMelee_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_SmasherRadialMelee_C*>(UGAB_SmasherRadialMelee_C::StaticClass()->DefaultObject);
