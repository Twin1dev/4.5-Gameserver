...
class UClass* UGAB_TakerSwoopMelee_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_TakerSwoopMelee_C");

	return Clss;
}


// GAB_TakerSwoopMelee_C GAB_TakerSwoopMelee.Default__GAB_TakerSwoopMelee_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_TakerSwoopMelee_C* UGAB_TakerSwoopMelee_C::GetDefaultObj()
{
	static class UGAB_TakerSwoopMelee_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_TakerSwoopMelee_C*>(UGAB_TakerSwoopMelee_C::StaticClass()->DefaultObject);
