...
class UClass* UMulchTileButton_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MulchTileButton_C");

	return Clss;
}


// MulchTileButton_C MulchTileButton.Default__MulchTileButton_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UMulchTileButton_C* UMulchTileButton_C::GetDefaultObj()
{
	static class UMulchTileButton_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UMulchTileButton_C*>(UMulchTileButton_C::StaticClass()->DefaultObject);
