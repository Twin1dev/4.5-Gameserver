...
class UClass* UGAB_HuskAttachedToShield_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_HuskAttachedToShield_C");

	return Clss;
}


// GAB_HuskAttachedToShield_C GAB_HuskAttachedToShield.Default__GAB_HuskAttachedToShield_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_HuskAttachedToShield_C* UGAB_HuskAttachedToShield_C::GetDefaultObj()
{
	static class UGAB_HuskAttachedToShield_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_HuskAttachedToShield_C*>(UGAB_HuskAttachedToShield_C::StaticClass()->DefaultObject);
