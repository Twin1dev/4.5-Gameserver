...
class UClass* UGAB_TakerPortalBase_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_TakerPortalBase_C");

	return Clss;
}


// GAB_TakerPortalBase_C GAB_TakerPortalBase.Default__GAB_TakerPortalBase_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_TakerPortalBase_C* UGAB_TakerPortalBase_C::GetDefaultObj()
{
	static class UGAB_TakerPortalBase_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_TakerPortalBase_C*>(UGAB_TakerPortalBase_C::StaticClass()->DefaultObject);
