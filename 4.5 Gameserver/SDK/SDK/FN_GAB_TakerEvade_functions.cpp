...
class UClass* UGAB_TakerEvade_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_TakerEvade_C");

	return Clss;
}


// GAB_TakerEvade_C GAB_TakerEvade.Default__GAB_TakerEvade_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_TakerEvade_C* UGAB_TakerEvade_C::GetDefaultObj()
{
	static class UGAB_TakerEvade_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_TakerEvade_C*>(UGAB_TakerEvade_C::StaticClass()->DefaultObject);
