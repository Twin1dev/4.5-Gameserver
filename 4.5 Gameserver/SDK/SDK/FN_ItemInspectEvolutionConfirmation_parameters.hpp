...
public:
	...
	class FText                                  CallFunc_GetEvolveRestrictionReasonText_ReturnValue1; // 0x28(0x18)(None)
	...
	class FText                                  CallFunc_GetEvolveRestrictionReasonText_ReturnValue2; // 0x60(0x18)(None)
...
public:
	...
	struct FRecipe                               CallFunc_Array_Get_Item;                           // 0x80(0x58)(None)
	...
	struct FFortItemQuantityPair                 CallFunc_Array_Get_Item1;                          // 0xE0(0x30)(None)
	...
	uint8                                        Pad_4C0[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FFortItemQuantityPair                 CallFunc_Array_Get_Item1;                          // 0xA8(0x30)(None)
	...
	class FText                                  CallFunc_GetDisplayName_ReturnValue;               // 0xE8(0x18)(None)
};
