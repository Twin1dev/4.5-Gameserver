...
public:
	...
	uint8                                        Pad_55E2[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_55E5[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            CallFunc_CalculateRocketSpawnLocation_Transform;   // 0x30(0x30)(IsPlainOldData, NoDestructor)
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue; // 0x60(0x80)(None)
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x108(0xA8)(None)
};
