...
class UClass* UGameplayTags_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GameplayTags_C");

	return Clss;
}


// GameplayTags_C GameplayTags.Default__GameplayTags_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGameplayTags_C* UGameplayTags_C::GetDefaultObj()
{
	static class UGameplayTags_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGameplayTags_C*>(UGameplayTags_C::StaticClass()->DefaultObject);
