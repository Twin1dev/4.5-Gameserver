...
class UClass* UIsStandingOnActor_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("IsStandingOnActor_C");

	return Clss;
}


// IsStandingOnActor_C IsStandingOnActor.Default__IsStandingOnActor_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UIsStandingOnActor_C* UIsStandingOnActor_C::GetDefaultObj()
{
	static class UIsStandingOnActor_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UIsStandingOnActor_C*>(UIsStandingOnActor_C::StaticClass()->DefaultObject);
