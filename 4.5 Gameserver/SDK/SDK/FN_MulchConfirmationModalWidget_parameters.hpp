...
public:
	...
	class FText                                  Temp_text_Variable2;                               // 0x90(0x18)(None)
	class FText                                  Temp_text_Variable3;                               // 0xA8(0x18)(None)
	class FText                                  Temp_text_Variable4;                               // 0xC0(0x18)(None)
	...
	class FText                                  Temp_text_Variable5;                               // 0x1B8(0x18)(None)
	...
	uint8                                        Pad_3411[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  K2Node_Select1_Default;                            // 0x220(0x18)(None)
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue;               // 0x2D8(0x18)(None)
...
public:
	...
	class FText                                  K2Node_Select1_Default;                            // 0x1A0(0x18)(None)
