...
void URewardsIcon_C::BndEvt__LoadGuard_K2Node_ComponentBoundEvent_2_OnLoadingStateChanged__DelegateSignature(bool bIsLoading)
{
	...
	if (!Func)
		Func = Class->GetFunction("RewardsIcon_C", "BndEvt__LoadGuard_K2Node_ComponentBoundEvent_2_OnLoadingStateChanged__DelegateSignature");
...
void URewardsIcon_C::OnAssetLoaded(class UObject* Object)
{
	...
	if (!Func)
		Func = Class->GetFunction("RewardsIcon_C", "OnAssetLoaded");
