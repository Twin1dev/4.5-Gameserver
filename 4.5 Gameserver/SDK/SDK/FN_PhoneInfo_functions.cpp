...
class UClass* UPhoneInfo_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PhoneInfo_C");

	return Clss;
}


// PhoneInfo_C PhoneInfo.Default__PhoneInfo_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPhoneInfo_C* UPhoneInfo_C::GetDefaultObj()
{
	static class UPhoneInfo_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPhoneInfo_C*>(UPhoneInfo_C::StaticClass()->DefaultObject);
...
// TScriptInterface<class ISlateTextureAtlasInterface>CallFunc_SetBrushFromAtlasInterface_AtlasRegion1_CastInput       (ZeroConstructor, IsPlainOldData, NoDestructor)
// TScriptInterface<class ISlateTextureAtlasInterface>CallFunc_SetBrushFromAtlasInterface_AtlasRegion2_CastInput       (ZeroConstructor, IsPlainOldData, NoDestructor)
// TScriptInterface<class ISlateTextureAtlasInterface>CallFunc_SetBrushFromAtlasInterface_AtlasRegion3_CastInput       (ZeroConstructor, IsPlainOldData, NoDestructor)
// class UAthenaHUDContext*           CallFunc_GetContext_ReturnValue                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TScriptInterface<class ISlateTextureAtlasInterface>CallFunc_SetBrushFromAtlasInterface_AtlasRegion4_CastInput       (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UPhoneInfo_C::BatteryTimerUpdate(float Float, TScriptInterface<class ISlateTextureAtlasInterface> CallFunc_SetBrushFromAtlasInterface_AtlasRegion_CastInput, TScriptInterface<class ISlateTextureAtlasInterface> CallFunc_SetBrushFromAtlasInterface_AtlasRegion1_CastInput, TScriptInterface<class ISlateTextureAtlasInterface> CallFunc_SetBrushFromAtlasInterface_AtlasRegion2_CastInput, TScriptInterface<class ISlateTextureAtlasInterface> CallFunc_SetBrushFromAtlasInterface_AtlasRegion3_CastInput, class UAthenaHUDContext* CallFunc_GetContext_ReturnValue, TScriptInterface<class ISlateTextureAtlasInterface> CallFunc_SetBrushFromAtlasInterface_AtlasRegion4_CastInput, float CallFunc_GetBatteryLevel_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue1, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue2)
{
	static class UFunction* Func = nullptr;
