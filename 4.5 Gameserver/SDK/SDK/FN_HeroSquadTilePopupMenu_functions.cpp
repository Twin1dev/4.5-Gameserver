...
class UClass* UHeroSquadTilePopupMenu_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HeroSquadTilePopupMenu_C");

	return Clss;
}


// HeroSquadTilePopupMenu_C HeroSquadTilePopupMenu.Default__HeroSquadTilePopupMenu_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHeroSquadTilePopupMenu_C* UHeroSquadTilePopupMenu_C::GetDefaultObj()
{
	static class UHeroSquadTilePopupMenu_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHeroSquadTilePopupMenu_C*>(UHeroSquadTilePopupMenu_C::StaticClass()->DefaultObject);
