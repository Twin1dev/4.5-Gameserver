...
public:
	...
	struct FGameplayEffectSpecHandle             CallFunc_MakeOutgoingGameplayEffectSpec_ReturnValue; // 0x40(0x18)(None)
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable;                              // 0x80(0x20)(None)
	...
	uint8                                        Pad_4252[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasMatchingGameplayTag_self_CastInput;    // 0x110(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x1C0(0xA8)(None)
