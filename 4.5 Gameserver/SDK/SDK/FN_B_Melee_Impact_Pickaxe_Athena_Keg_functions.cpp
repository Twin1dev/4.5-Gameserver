...
class UClass* AB_Melee_Impact_Pickaxe_Athena_Keg_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Melee_Impact_Pickaxe_Athena_Keg_C");

	return Clss;
}


// B_Melee_Impact_Pickaxe_Athena_Keg_C B_Melee_Impact_Pickaxe_Athena_Keg.Default__B_Melee_Impact_Pickaxe_Athena_Keg_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Melee_Impact_Pickaxe_Athena_Keg_C* AB_Melee_Impact_Pickaxe_Athena_Keg_C::GetDefaultObj()
{
	static class AB_Melee_Impact_Pickaxe_Athena_Keg_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Melee_Impact_Pickaxe_Athena_Keg_C*>(AB_Melee_Impact_Pickaxe_Athena_Keg_C::StaticClass()->DefaultObject);
