...
class UClass* ASmasherPawn_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SmasherPawn_C");

	return Clss;
}


// SmasherPawn_C SmasherPawn.Default__SmasherPawn_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ASmasherPawn_C* ASmasherPawn_C::GetDefaultObj()
{
	static class ASmasherPawn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ASmasherPawn_C*>(ASmasherPawn_C::StaticClass()->DefaultObject);
