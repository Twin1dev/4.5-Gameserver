...
class UClass* AAbilityDecoTool_AirStrike_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AbilityDecoTool_AirStrike_C");

	return Clss;
}


// AbilityDecoTool_AirStrike_C AbilityDecoTool_AirStrike.Default__AbilityDecoTool_AirStrike_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AAbilityDecoTool_AirStrike_C* AAbilityDecoTool_AirStrike_C::GetDefaultObj()
{
	static class AAbilityDecoTool_AirStrike_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AAbilityDecoTool_AirStrike_C*>(AAbilityDecoTool_AirStrike_C::StaticClass()->DefaultObject);
