...
class UClass* AB_FDP_SentryGun_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_FDP_SentryGun_C");

	return Clss;
}


// B_FDP_SentryGun_C B_FDP_SentryGun.Default__B_FDP_SentryGun_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_FDP_SentryGun_C* AB_FDP_SentryGun_C::GetDefaultObj()
{
	static class AB_FDP_SentryGun_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_FDP_SentryGun_C*>(AB_FDP_SentryGun_C::StaticClass()->DefaultObject);
