...
class UClass* AFlingerPawn_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FlingerPawn_C");

	return Clss;
}


// FlingerPawn_C FlingerPawn.Default__FlingerPawn_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AFlingerPawn_C* AFlingerPawn_C::GetDefaultObj()
{
	static class AFlingerPawn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AFlingerPawn_C*>(AFlingerPawn_C::StaticClass()->DefaultObject);
