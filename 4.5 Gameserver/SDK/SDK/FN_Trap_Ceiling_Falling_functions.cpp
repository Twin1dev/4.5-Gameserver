...
class UClass* ATrap_Ceiling_Falling_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Trap_Ceiling_Falling_C");

	return Clss;
}


// Trap_Ceiling_Falling_C Trap_Ceiling_Falling.Default__Trap_Ceiling_Falling_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ATrap_Ceiling_Falling_C* ATrap_Ceiling_Falling_C::GetDefaultObj()
{
	static class ATrap_Ceiling_Falling_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ATrap_Ceiling_Falling_C*>(ATrap_Ceiling_Falling_C::StaticClass()->DefaultObject);
