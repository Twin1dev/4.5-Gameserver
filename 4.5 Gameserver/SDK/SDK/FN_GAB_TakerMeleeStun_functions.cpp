...
class UClass* UGAB_TakerMeleeStun_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_TakerMeleeStun_C");

	return Clss;
}


// GAB_TakerMeleeStun_C GAB_TakerMeleeStun.Default__GAB_TakerMeleeStun_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_TakerMeleeStun_C* UGAB_TakerMeleeStun_C::GetDefaultObj()
{
	static class UGAB_TakerMeleeStun_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_TakerMeleeStun_C*>(UGAB_TakerMeleeStun_C::StaticClass()->DefaultObject);
