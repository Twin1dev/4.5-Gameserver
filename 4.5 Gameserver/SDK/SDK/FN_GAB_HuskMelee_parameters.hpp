...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable;                              // 0x70(0x20)(None)
	...
	uint8                                        Pad_3CB2[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	UDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate6;             // 0x168(0x10)(ZeroConstructor, NoDestructor)
	struct FGameplayAbilityTargetDataHandle      K2Node_CustomEvent_Target_Data;                    // 0x178(0x20)(None)
