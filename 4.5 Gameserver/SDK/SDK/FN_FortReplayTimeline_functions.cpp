...
class UClass* UFortReplayTimeline_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FortReplayTimeline_C");

	return Clss;
}


// FortReplayTimeline_C FortReplayTimeline.Default__FortReplayTimeline_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFortReplayTimeline_C* UFortReplayTimeline_C::GetDefaultObj()
{
	static class UFortReplayTimeline_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortReplayTimeline_C*>(UFortReplayTimeline_C::StaticClass()->DefaultObject);
