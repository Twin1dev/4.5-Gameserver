...
{
public:
	struct FGameplayTagContainer                 CallFunc_GetMissionAlertVisualTags_ReturnValue;    // 0x0(0x20)(None)
	struct FGameplayTagQuery                     CallFunc_MakeGameplayTagQuery_ReturnValue;         // 0x20(0x48)(None)
	struct FGameplayTagContainer                 CallFunc_GetMissionAlertVisualTags_ReturnValue1;   // 0x68(0x20)(None)
	...
	struct FGameplayTagContainer                 CallFunc_GetMissionAlertVisualTags_ReturnValue2;   // 0x90(0x20)(None)
	...
	struct FGameplayTagQuery                     CallFunc_MakeGameplayTagQuery_ReturnValue1;        // 0xC8(0x48)(None)
...
public:
	...
	struct FFortMissionDetails                   CallFunc_GetTileMissionDetails_MissionDetails;     // 0x190(0x168)(None)
	...
	class FText                                  CallFunc_Get_Conning_Color_From_Difficulty_Value_TooltipText; // 0x320(0x18)(None)
	...
	struct FFortMissionDetails                   CallFunc_GetTileMissionDetails_MissionDetails1;    // 0x348(0x168)(None)
	...
	struct FFortHomeBaseInfo                     CallFunc_GetHomeBaseInfoForPlayer_Result;          // 0x568(0x40)(None)
