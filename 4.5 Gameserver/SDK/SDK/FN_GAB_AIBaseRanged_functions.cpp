...
class UClass* UGAB_AIBaseRanged_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_AIBaseRanged_C");

	return Clss;
}


// GAB_AIBaseRanged_C GAB_AIBaseRanged.Default__GAB_AIBaseRanged_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_AIBaseRanged_C* UGAB_AIBaseRanged_C::GetDefaultObj()
{
	static class UGAB_AIBaseRanged_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_AIBaseRanged_C*>(UGAB_AIBaseRanged_C::StaticClass()->DefaultObject);
