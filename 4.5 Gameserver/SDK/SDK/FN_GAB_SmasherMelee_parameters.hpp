...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable;                              // 0x90(0x20)(None)
	...
	uint8                                        Pad_382C[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActorArray_ReturnValue; // 0x208(0x20)(None)
	...
	TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasAllMatchingGameplayTags_TagContainerInterface_CastInput; // 0x268(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasAllMatchingGameplayTags_TagContainerInterface1_CastInput; // 0x280(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
