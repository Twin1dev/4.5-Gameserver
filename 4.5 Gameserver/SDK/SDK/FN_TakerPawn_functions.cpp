...
class UClass* ATakerPawn_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TakerPawn_C");

	return Clss;
}


// TakerPawn_C TakerPawn.Default__TakerPawn_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ATakerPawn_C* ATakerPawn_C::GetDefaultObj()
{
	static class ATakerPawn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ATakerPawn_C*>(ATakerPawn_C::StaticClass()->DefaultObject);
