...
class UClass* UButton_Shoot_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Button_Shoot_C");

	return Clss;
}


// Button_Shoot_C Button_Shoot.Default__Button_Shoot_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UButton_Shoot_C* UButton_Shoot_C::GetDefaultObj()
{
	static class UButton_Shoot_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UButton_Shoot_C*>(UButton_Shoot_C::StaticClass()->DefaultObject);
