...
class UClass* UGAB_HuskMelee_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_HuskMelee_C");

	return Clss;
}


// GAB_HuskMelee_C GAB_HuskMelee.Default__GAB_HuskMelee_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_HuskMelee_C* UGAB_HuskMelee_C::GetDefaultObj()
{
	static class UGAB_HuskMelee_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_HuskMelee_C*>(UGAB_HuskMelee_C::StaticClass()->DefaultObject);
