...
class UClass* ABP_Hex_Outpost_Theater2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Hex_Outpost_Theater2_C");

	return Clss;
}


// BP_Hex_Outpost_Theater2_C BP_Hex_Outpost_Theater2.Default__BP_Hex_Outpost_Theater2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Hex_Outpost_Theater2_C* ABP_Hex_Outpost_Theater2_C::GetDefaultObj()
{
	static class ABP_Hex_Outpost_Theater2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Hex_Outpost_Theater2_C*>(ABP_Hex_Outpost_Theater2_C::StaticClass()->DefaultObject);
