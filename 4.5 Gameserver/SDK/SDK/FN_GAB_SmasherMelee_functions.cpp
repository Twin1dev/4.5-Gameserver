...
class UClass* UGAB_SmasherMelee_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_SmasherMelee_C");

	return Clss;
}


// GAB_SmasherMelee_C GAB_SmasherMelee.Default__GAB_SmasherMelee_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_SmasherMelee_C* UGAB_SmasherMelee_C::GetDefaultObj()
{
	static class UGAB_SmasherMelee_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_SmasherMelee_C*>(UGAB_SmasherMelee_C::StaticClass()->DefaultObject);
