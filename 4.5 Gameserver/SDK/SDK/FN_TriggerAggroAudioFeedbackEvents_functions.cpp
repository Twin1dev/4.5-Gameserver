...
class UClass* UTriggerAggroAudioFeedbackEvents_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("TriggerAggroAudioFeedbackEvents_C");

	return Clss;
}


// TriggerAggroAudioFeedbackEvents_C TriggerAggroAudioFeedbackEvents.Default__TriggerAggroAudioFeedbackEvents_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UTriggerAggroAudioFeedbackEvents_C* UTriggerAggroAudioFeedbackEvents_C::GetDefaultObj()
{
	static class UTriggerAggroAudioFeedbackEvents_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UTriggerAggroAudioFeedbackEvents_C*>(UTriggerAggroAudioFeedbackEvents_C::StaticClass()->DefaultObject);
