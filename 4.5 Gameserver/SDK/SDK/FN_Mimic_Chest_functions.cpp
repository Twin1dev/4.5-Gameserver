...
class UClass* AMimic_Chest_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Mimic_Chest_C");

	return Clss;
}


// Mimic_Chest_C Mimic_Chest.Default__Mimic_Chest_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AMimic_Chest_C* AMimic_Chest_C::GetDefaultObj()
{
	static class AMimic_Chest_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AMimic_Chest_C*>(AMimic_Chest_C::StaticClass()->DefaultObject);
