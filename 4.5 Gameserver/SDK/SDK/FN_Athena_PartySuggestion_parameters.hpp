...
public:
	...
	struct FFortPartySuggestion                  K2Node_CustomEvent_Party_Suggestion_Struct;        // 0x138(0x80)(None)
	class FText                                  CallFunc_GetPartySuggestionActionText_ActionText;  // 0x1B8(0x18)(None)
	...
	struct FFortPartySuggestion                  K2Node_CustomEvent_PartySuggestionStruct;          // 0x1D8(0x80)(None)
	...
	class FText                                  K2Node_Select2_Default;                            // 0x2F0(0x18)(None)
