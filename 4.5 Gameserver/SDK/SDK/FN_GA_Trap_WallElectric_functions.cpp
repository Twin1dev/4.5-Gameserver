...
class UClass* UGA_Trap_WallElectric_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Trap_WallElectric_C");

	return Clss;
}


// GA_Trap_WallElectric_C GA_Trap_WallElectric.Default__GA_Trap_WallElectric_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Trap_WallElectric_C* UGA_Trap_WallElectric_C::GetDefaultObj()
{
	static class UGA_Trap_WallElectric_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Trap_WallElectric_C*>(UGA_Trap_WallElectric_C::StaticClass()->DefaultObject);
