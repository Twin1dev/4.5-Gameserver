...
public:
	...
	struct FMovieSceneFloatChannel               Translation[0x3];                                  // 0xE8(0x1B0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               Rotation[0x3];                                     // 0x298(0x1B0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               Scale[0x3];                                        // 0x448(0x1B0)(NativeAccessSpecifierPrivate)
...
{
public:
	struct FMovieSceneFloatChannel               Curves[0x4];                                       // 0xE0(0x240)(NativeAccessSpecifierPrivate)
