...
class UClass* AMimic_Mission_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Mimic_Mission_C");

	return Clss;
}


// Mimic_Mission_C Mimic_Mission.Default__Mimic_Mission_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AMimic_Mission_C* AMimic_Mission_C::GetDefaultObj()
{
	static class AMimic_Mission_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AMimic_Mission_C*>(AMimic_Mission_C::StaticClass()->DefaultObject);
...
// struct FFortEncounterSettings      K2Node_MakeStruct_FortEncounterSettings                          (None)
...
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor)
// struct FGuid                       CallFunc_GetMissionGuid_ReturnValue                              (IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FFortMissionWeightedReward  CallFunc_ChooseRandomReward_ReturnValue                          (None)
