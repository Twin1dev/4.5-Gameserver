...
public:
	...
	struct FHomebaseSquad                        CallFunc_TryGetHomebaseSquadData_OutHomebaseSquad; // 0x70(0x88)(None)
	...
	struct FHomebaseSquadSlot                    CallFunc_Array_Get_Item;                           // 0x108(0x68)(None)
	...
	uint8                                        Pad_BC5[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  CallFunc_ToText_ReturnValue;                       // 0x178(0x18)(None)
	...
	class FText                                  CallFunc_GetRestrictionReasonsAsText_Text;         // 0x1B0(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue1;                      // 0x310(0x18)(None)
};
