...
class UClass* UCustomFilterModal_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CustomFilterModal_C");

	return Clss;
}


// CustomFilterModal_C CustomFilterModal.Default__CustomFilterModal_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCustomFilterModal_C* UCustomFilterModal_C::GetDefaultObj()
{
	static class UCustomFilterModal_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCustomFilterModal_C*>(UCustomFilterModal_C::StaticClass()->DefaultObject);
