...
public:
	...
	struct FFortBasicMissionInfo                 CallFunc_GetCurrentBasicMissionInfo_BasicMissionInfo; // 0x8(0x388)(None)
	...
	class FText                                  CallFunc_TextToUpper_ReturnValue;                  // 0x428(0x18)(None)
	class FText                                  CallFunc_Format_ReturnValue;                       // 0x440(0x18)(None)
};
