...
class UClass* UFortReplayViewSettings_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FortReplayViewSettings_C");

	return Clss;
}


// FortReplayViewSettings_C FortReplayViewSettings.Default__FortReplayViewSettings_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFortReplayViewSettings_C* UFortReplayViewSettings_C::GetDefaultObj()
{
	static class UFortReplayViewSettings_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFortReplayViewSettings_C*>(UFortReplayViewSettings_C::StaticClass()->DefaultObject);
