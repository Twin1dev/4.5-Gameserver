...
namespace FMemory
{
	static inline void* (*Realloc)(void*, __int64, unsigned int) = decltype(Realloc)(__int64(GetModuleHandleW(0)) + 0x134a5f0);
}
...
public:
	...
	inline void Free()
	{
		// usually we would use FMemory::Free, but you dont have to
		if (Data)
			VirtualFree(Data, sizeof(T) * NumElements, MEM_RELEASE);
