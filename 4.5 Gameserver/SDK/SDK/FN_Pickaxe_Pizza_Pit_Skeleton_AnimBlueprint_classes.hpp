...
public:
	...
	struct FAnimNode_SubInput                    AnimGraphNode_SubInput_070E9EDA451C23C20742F1A3CEA36E92; // 0x418(0x68)(None)
	struct FAnimNode_ConvertLocalToComponentSpace AnimGraphNode_LocalToComponentSpace_151ADE244279A7A42130649830A169AC; // 0x480(0x48)(None)
	struct FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace_F8CB432B4692B3C54E96EAB243541C63; // 0x4C8(0x48)(None)
	struct FAnimNode_Root                        AnimGraphNode_Root_EC80E3A14FFEF078D3064A8578FD21FF; // 0x510(0x48)(None)
	uint8                                        Pad_35A0[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAnimNode_RigidBody                   AnimGraphNode_RigidBody_A4C70D374ADF4261AD134E800DC2E8CD; // 0x560(0x590)(None)
