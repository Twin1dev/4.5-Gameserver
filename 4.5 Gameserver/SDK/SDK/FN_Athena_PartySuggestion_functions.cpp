...
class UClass* UAthena_PartySuggestion_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Athena_PartySuggestion_C");

	return Clss;
}


// Athena_PartySuggestion_C Athena_PartySuggestion.Default__Athena_PartySuggestion_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthena_PartySuggestion_C* UAthena_PartySuggestion_C::GetDefaultObj()
{
	static class UAthena_PartySuggestion_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthena_PartySuggestion_C*>(UAthena_PartySuggestion_C::StaticClass()->DefaultObject);
...
// class FText                        CallFunc_GetPartySuggestionActionText_ActionText                 (None)
