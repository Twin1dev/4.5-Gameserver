...
class UClass* UAthenaSpectatorHUD_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaSpectatorHUD_C");

	return Clss;
}


// AthenaSpectatorHUD_C AthenaSpectatorHUD.Default__AthenaSpectatorHUD_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaSpectatorHUD_C* UAthenaSpectatorHUD_C::GetDefaultObj()
{
	static class UAthenaSpectatorHUD_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaSpectatorHUD_C*>(UAthenaSpectatorHUD_C::StaticClass()->DefaultObject);
