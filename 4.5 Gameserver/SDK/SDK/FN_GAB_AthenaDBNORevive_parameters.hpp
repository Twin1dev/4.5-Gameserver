...
public:
	...
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable3;                             // 0xA8(0x20)(None)
	...
	struct FFortGameplayEffectContainerSpec      CallFunc_MakeGameplayEffectContainerSpec_ReturnValue; // 0x1C8(0x80)(None)
	struct FGameplayAbilityActorInfo             CallFunc_GetActorInfo_ReturnValue;                 // 0x248(0x40)(ContainsInstancedReference)
	struct FFortAbilityTargetSelection           CallFunc_Array_Get_Item;                           // 0x288(0x100)(None)
