...
class UClass* UGAB_AIBaseSimpleMontage_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_AIBaseSimpleMontage_C");

	return Clss;
}


// GAB_AIBaseSimpleMontage_C GAB_AIBaseSimpleMontage.Default__GAB_AIBaseSimpleMontage_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_AIBaseSimpleMontage_C* UGAB_AIBaseSimpleMontage_C::GetDefaultObj()
{
	static class UGAB_AIBaseSimpleMontage_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_AIBaseSimpleMontage_C*>(UGAB_AIBaseSimpleMontage_C::StaticClass()->DefaultObject);
