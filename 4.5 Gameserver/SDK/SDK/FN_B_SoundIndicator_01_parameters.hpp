...
public:
	...
	struct FRuntimeFloatCurve                    K2Node_Select_Default;                             // 0x80(0x78)(None)
	struct FRuntimeFloatCurve                    K2Node_Select1_Default;                            // 0xF8(0x78)(None)
};
...
public:
	...
	struct FRuntimeFloatCurve                    CallFunc_GetWeaponCurve_ReturnValue;               // 0x8(0x78)(None)
