...
class UClass* UGAB_MimicMelee_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_MimicMelee_C");

	return Clss;
}


// GAB_MimicMelee_C GAB_MimicMelee.Default__GAB_MimicMelee_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_MimicMelee_C* UGAB_MimicMelee_C::GetDefaultObj()
{
	static class UGAB_MimicMelee_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_MimicMelee_C*>(UGAB_MimicMelee_C::StaticClass()->DefaultObject);
...
// struct FGameplayAbilityTargetDataHandleK2Node_Event_Target_Data                                         (None)
