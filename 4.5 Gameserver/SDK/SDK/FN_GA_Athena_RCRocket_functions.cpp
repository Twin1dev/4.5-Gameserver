...
class UClass* UGA_Athena_RCRocket_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_RCRocket_C");

	return Clss;
}


// GA_Athena_RCRocket_C GA_Athena_RCRocket.Default__GA_Athena_RCRocket_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_RCRocket_C* UGA_Athena_RCRocket_C::GetDefaultObj()
{
	static class UGA_Athena_RCRocket_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_RCRocket_C*>(UGA_Athena_RCRocket_C::StaticClass()->DefaultObject);
