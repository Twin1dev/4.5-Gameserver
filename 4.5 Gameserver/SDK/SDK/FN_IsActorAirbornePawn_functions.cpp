...
class UClass* UIsActorAirbornePawn_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("IsActorAirbornePawn_C");

	return Clss;
}


// IsActorAirbornePawn_C IsActorAirbornePawn.Default__IsActorAirbornePawn_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UIsActorAirbornePawn_C* UIsActorAirbornePawn_C::GetDefaultObj()
{
	static class UIsActorAirbornePawn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UIsActorAirbornePawn_C*>(UIsActorAirbornePawn_C::StaticClass()->DefaultObject);
