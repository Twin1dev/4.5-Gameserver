...
class UClass* UIsStandingOnStructurallyUnsupportedFloor_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("IsStandingOnStructurallyUnsupportedFloor_C");

	return Clss;
}


// IsStandingOnStructurallyUnsupportedFloor_C IsStandingOnStructurallyUnsupportedFloor.Default__IsStandingOnStructurallyUnsupportedFloor_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UIsStandingOnStructurallyUnsupportedFloor_C* UIsStandingOnStructurallyUnsupportedFloor_C::GetDefaultObj()
{
	static class UIsStandingOnStructurallyUnsupportedFloor_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UIsStandingOnStructurallyUnsupportedFloor_C*>(UIsStandingOnStructurallyUnsupportedFloor_C::StaticClass()->DefaultObject);
