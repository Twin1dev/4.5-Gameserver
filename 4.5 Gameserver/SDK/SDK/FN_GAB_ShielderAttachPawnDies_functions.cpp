...
class UClass* UGAB_ShielderAttachPawnDies_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_ShielderAttachPawnDies_C");

	return Clss;
}


// GAB_ShielderAttachPawnDies_C GAB_ShielderAttachPawnDies.Default__GAB_ShielderAttachPawnDies_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_ShielderAttachPawnDies_C* UGAB_ShielderAttachPawnDies_C::GetDefaultObj()
{
	static class UGAB_ShielderAttachPawnDies_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_ShielderAttachPawnDies_C*>(UGAB_ShielderAttachPawnDies_C::StaticClass()->DefaultObject);
