...
public:
	...
	uint8                                        Pad_33C8[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  Temp_text_Variable4;                               // 0xE8(0x18)(None)
	class FText                                  K2Node_Select1_Default;                            // 0x100(0x18)(None)
	class FText                                  Temp_text_Variable5;                               // 0x118(0x18)(None)
