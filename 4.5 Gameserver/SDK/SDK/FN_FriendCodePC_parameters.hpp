...
public:
	...
	class FText                                  CallFunc_GetFriendCodeDisplayName_ReturnValue;     // 0x20(0x18)(None)
	class FText                                  CallFunc_GetFriendCodeDescription_ReturnValue;     // 0x38(0x18)(None)
...
public:
	...
	class FText                                  CallFunc_GetCodeText_Result;                       // 0x138(0x18)(None)
