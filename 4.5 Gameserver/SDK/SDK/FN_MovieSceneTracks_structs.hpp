...
public:
	...
	uint8                                        Pad_9AC[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FFrameNumber                          Time;                                              // 0x14(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_9AD[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FMovieSceneFloatChannel               TranslationCurve[0x3];                             // 0x0(0x1B0)(NativeAccessSpecifierPublic)
	struct FMovieSceneFloatChannel               RotationCurve[0x3];                                // 0x1B0(0x1B0)(NativeAccessSpecifierPublic)
	struct FMovieSceneFloatChannel               ScaleCurve[0x3];                                   // 0x360(0x1B0)(NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_9B4[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FMovieSceneActorReferenceKey>  KeyValues;                                         // 0x28(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_9B5[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_9D5[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FMovieSceneFloatChannel               Curves[0x4];                                       // 0x48(0x240)(NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_9DD[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FMovieSceneFloatChannel               ComponentCurves[0x4];                              // 0x48(0x240)(Protected, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_9F6[0x67];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_A03[0x1C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
