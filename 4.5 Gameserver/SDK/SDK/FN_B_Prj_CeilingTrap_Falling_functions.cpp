...
class UClass* AB_Prj_CeilingTrap_Falling_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Prj_CeilingTrap_Falling_C");

	return Clss;
}


// B_Prj_CeilingTrap_Falling_C B_Prj_CeilingTrap_Falling.Default__B_Prj_CeilingTrap_Falling_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Prj_CeilingTrap_Falling_C* AB_Prj_CeilingTrap_Falling_C::GetDefaultObj()
{
	static class AB_Prj_CeilingTrap_Falling_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Prj_CeilingTrap_Falling_C*>(AB_Prj_CeilingTrap_Falling_C::StaticClass()->DefaultObject);
