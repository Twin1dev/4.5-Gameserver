...
class UClass* UPartyFinderListItem_New_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PartyFinderListItem_New_C");

	return Clss;
}


// PartyFinderListItem_New_C PartyFinderListItem_New.Default__PartyFinderListItem_New_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPartyFinderListItem_New_C* UPartyFinderListItem_New_C::GetDefaultObj()
{
	static class UPartyFinderListItem_New_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPartyFinderListItem_New_C*>(UPartyFinderListItem_New_C::StaticClass()->DefaultObject);
...
void UPartyFinderListItem_New_C::RequestClosePartyFinder__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("PartyFinderListItem_New_C", "RequestClosePartyFinder__DelegateSignature");
...
void UPartyFinderListItem_New_C::InviteJoinChanged__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("PartyFinderListItem_New_C", "InviteJoinChanged__DelegateSignature");
