...
public:
	...
	class UMaterialInstanceDynamic*              MIDMinusCheckBox;                                  // 0x378(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
