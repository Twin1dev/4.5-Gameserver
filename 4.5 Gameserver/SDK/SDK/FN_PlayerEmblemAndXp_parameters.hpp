...
public:
	...
	struct FFortItemQuantityPair                 CallFunc_GetNextSeasonReward_Reward;               // 0x90(0x30)(None)
	...
	struct FFortItemQuantityPair                 CallFunc_GetNextSeasonChaseReward_Reward;          // 0xD0(0x30)(None)
