...
public:
	...
	class FText                                  CallFunc_GetTertiaryCategory_ItemCategoryText;     // 0x1B8(0x18)(None)
	struct FSlateBrush                           CallFunc_GetTertiaryCategory_ItemCategoryBrush;    // 0x1D0(0x88)(None)
	...
	class FText                                  CallFunc_GetDisplayName_ReturnValue;               // 0x2C0(0x18)(None)
	...
	class FText                                  CallFunc_TextTrimPrecedingAndTrailing_ReturnValue; // 0x2F8(0x18)(None)
	...
	class FText                                  K2Node_Select1_Default;                            // 0x378(0x18)(None)
};
