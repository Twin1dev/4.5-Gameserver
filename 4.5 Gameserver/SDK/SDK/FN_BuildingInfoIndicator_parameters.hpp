...
public:
	...
	uint8                                        Pad_499F[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FSlateBrush                           CallFunc_GetItemDefinitionSmallPreviewImageBrush_ReturnValue; // 0x68(0x88)(None)
	...
	uint8                                        Pad_49A4[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetTrapAttachTypeName_ReturnValue;        // 0x170(0x18)(None)
