...
class UClass* UGA_Athena_PurpleStuff_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_PurpleStuff_C");

	return Clss;
}


// GA_Athena_PurpleStuff_C GA_Athena_PurpleStuff.Default__GA_Athena_PurpleStuff_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_PurpleStuff_C* UGA_Athena_PurpleStuff_C::GetDefaultObj()
{
	static class UGA_Athena_PurpleStuff_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_PurpleStuff_C*>(UGA_Athena_PurpleStuff_C::StaticClass()->DefaultObject);
...
void UGA_Athena_PurpleStuff_C::K2_OnEndAbility(bool bWasCancelled)
{
	...
	if (!Func)
		Func = Class->GetFunction("GA_Athena_PurpleStuff_C", "K2_OnEndAbility");
