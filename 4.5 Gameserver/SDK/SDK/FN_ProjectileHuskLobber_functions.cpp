...
class UClass* AProjectileHuskLobber_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ProjectileHuskLobber_C");

	return Clss;
}


// ProjectileHuskLobber_C ProjectileHuskLobber.Default__ProjectileHuskLobber_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AProjectileHuskLobber_C* AProjectileHuskLobber_C::GetDefaultObj()
{
	static class AProjectileHuskLobber_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AProjectileHuskLobber_C*>(AProjectileHuskLobber_C::StaticClass()->DefaultObject);
...
void AProjectileHuskLobber_C::ProjectileShot__DelegateSignature(const struct FVector& Location)
{
	...
	if (!Func)
		Func = Class->GetFunction("ProjectileHuskLobber_C", "ProjectileShot__DelegateSignature");
