...
class UClass* UAthena_LFG_SuggestedPartyItem_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Athena_LFG_SuggestedPartyItem_C");

	return Clss;
}


// Athena_LFG_SuggestedPartyItem_C Athena_LFG_SuggestedPartyItem.Default__Athena_LFG_SuggestedPartyItem_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthena_LFG_SuggestedPartyItem_C* UAthena_LFG_SuggestedPartyItem_C::GetDefaultObj()
{
	static class UAthena_LFG_SuggestedPartyItem_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthena_LFG_SuggestedPartyItem_C*>(UAthena_LFG_SuggestedPartyItem_C::StaticClass()->DefaultObject);
