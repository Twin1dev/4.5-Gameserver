...
class UClass* AB_Placement_Preview_AirStrike_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Placement_Preview_AirStrike_C");

	return Clss;
}


// B_Placement_Preview_AirStrike_C B_Placement_Preview_AirStrike.Default__B_Placement_Preview_AirStrike_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Placement_Preview_AirStrike_C* AB_Placement_Preview_AirStrike_C::GetDefaultObj()
{
	static class AB_Placement_Preview_AirStrike_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Placement_Preview_AirStrike_C*>(AB_Placement_Preview_AirStrike_C::StaticClass()->DefaultObject);
