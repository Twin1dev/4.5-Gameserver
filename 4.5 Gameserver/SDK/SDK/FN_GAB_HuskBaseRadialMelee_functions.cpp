...
class UClass* UGAB_HuskBaseRadialMelee_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_HuskBaseRadialMelee_C");

	return Clss;
}


// GAB_HuskBaseRadialMelee_C GAB_HuskBaseRadialMelee.Default__GAB_HuskBaseRadialMelee_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_HuskBaseRadialMelee_C* UGAB_HuskBaseRadialMelee_C::GetDefaultObj()
{
	static class UGAB_HuskBaseRadialMelee_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_HuskBaseRadialMelee_C*>(UGAB_HuskBaseRadialMelee_C::StaticClass()->DefaultObject);
