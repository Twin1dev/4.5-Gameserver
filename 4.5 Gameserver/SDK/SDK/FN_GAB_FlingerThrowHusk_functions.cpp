...
class UClass* UGAB_FlingerThrowHusk_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_FlingerThrowHusk_C");

	return Clss;
}


// GAB_FlingerThrowHusk_C GAB_FlingerThrowHusk.Default__GAB_FlingerThrowHusk_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_FlingerThrowHusk_C* UGAB_FlingerThrowHusk_C::GetDefaultObj()
{
	static class UGAB_FlingerThrowHusk_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_FlingerThrowHusk_C*>(UGAB_FlingerThrowHusk_C::StaticClass()->DefaultObject);
