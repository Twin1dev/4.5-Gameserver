...
class UClass* UGAB_FlingerMeleeSwipe_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_FlingerMeleeSwipe_C");

	return Clss;
}


// GAB_FlingerMeleeSwipe_C GAB_FlingerMeleeSwipe.Default__GAB_FlingerMeleeSwipe_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_FlingerMeleeSwipe_C* UGAB_FlingerMeleeSwipe_C::GetDefaultObj()
{
	static class UGAB_FlingerMeleeSwipe_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_FlingerMeleeSwipe_C*>(UGAB_FlingerMeleeSwipe_C::StaticClass()->DefaultObject);
