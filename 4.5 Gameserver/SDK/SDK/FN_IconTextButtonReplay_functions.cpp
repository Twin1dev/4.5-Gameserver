...
class UClass* UIconTextButtonReplay_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("IconTextButtonReplay_C");

	return Clss;
}


// IconTextButtonReplay_C IconTextButtonReplay.Default__IconTextButtonReplay_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UIconTextButtonReplay_C* UIconTextButtonReplay_C::GetDefaultObj()
{
	static class UIconTextButtonReplay_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UIconTextButtonReplay_C*>(UIconTextButtonReplay_C::StaticClass()->DefaultObject);
