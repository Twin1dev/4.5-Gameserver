...
void UToastDisplayArea_C::BndEvt__VoteResultNotificationWidget_K2Node_ComponentBoundEvent_0_OnToastFinished__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("ToastDisplayArea_C", "BndEvt__VoteResultNotificationWidget_K2Node_ComponentBoundEvent_0_OnToastFinished__DelegateSignature");
...
void UToastDisplayArea_C::BndEvt__VoteUpdateNotificationWidget_K2Node_ComponentBoundEvent_1_OnToastFinished__DelegateSignature()
{
	...
	if (!Func)
		Func = Class->GetFunction("ToastDisplayArea_C", "BndEvt__VoteUpdateNotificationWidget_K2Node_ComponentBoundEvent_1_OnToastFinished__DelegateSignature");
