...
public:
	...
	class FText                                  CallFunc_GetKeyTextForAction_ButtonActionType;     // 0x40(0x18)(None)
	class FText                                  CallFunc_GetKeyTextForAction_ReturnValue;          // 0x58(0x18)(None)
	...
	struct FSlateBrush                           CallFunc_GetBrushForKey_Brush;                     // 0x180(0x88)(None)
	...
	class FText                                  CallFunc_GetText_ReturnValue;                      // 0x210(0x18)(None)
