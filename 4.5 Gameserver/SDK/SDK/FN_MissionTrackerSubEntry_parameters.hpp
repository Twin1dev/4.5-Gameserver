...
public:
	...
	struct FFortClientAnnouncementData_Basic     K2Node_MakeStruct_FortClientAnnouncementData_Basic; // 0x8(0xE8)(None)
...
public:
	...
	uint8                                        Pad_4827[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FSlateBrush                           CallFunc_GetObjectiveBulletIcon_BulletIcon;        // 0x18(0x88)(None)
...
public:
	...
	TScriptInterface<class IMissionObjectiveContentWidgetInterface_C> K2Node_DynamicCast_AsMission_Objective_Content_Widget_Interface; // 0x28(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
