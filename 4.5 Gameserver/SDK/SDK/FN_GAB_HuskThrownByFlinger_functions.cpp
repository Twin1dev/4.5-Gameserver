...
class UClass* UGAB_HuskThrownByFlinger_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GAB_HuskThrownByFlinger_C");

	return Clss;
}


// GAB_HuskThrownByFlinger_C GAB_HuskThrownByFlinger.Default__GAB_HuskThrownByFlinger_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGAB_HuskThrownByFlinger_C* UGAB_HuskThrownByFlinger_C::GetDefaultObj()
{
	static class UGAB_HuskThrownByFlinger_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGAB_HuskThrownByFlinger_C*>(UGAB_HuskThrownByFlinger_C::StaticClass()->DefaultObject);
