...
public:
	...
	uint8                                        Pad_26D[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FSlateBrush                           GamepadSpecificBrushes[0x3];                       // 0x88(0x198)(Edit, NativeAccessSpecifierPublic)
...
public:
	...
	struct FCommonInputTypeInfo                  GamepadInputTypeInfos[0x3];                        // 0xE0(0x1F8)(Edit, Protected, NativeAccessSpecifierProtected)
